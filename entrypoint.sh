...
UUID=${UUID:-'57197584-dc58-49a3-a2eb-a25f2586cf57'}
VMESS_WSPATH=${VMESS_WSPATH:-'/api1'}
VLESS_WSPATH=${VLESS_WSPATH:-'/api2'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/api3'}
SS_WSPATH=${SS_WSPATH:-'/api4'}
